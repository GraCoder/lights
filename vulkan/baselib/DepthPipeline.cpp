...
void DepthPipeline::realize(VulkanPass *renderPass, int subpass)
{
  ...
  shaderStages[0].module = _device->createShader(SHADER_DIR "/depth.vert.spv");
  shaderStages[0].pName = "main";
  assert(shaderStages[0].module != VK_NULL_HANDLE);

  shaderStages[1].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
  shaderStages[1].stage = VK_SHADER_STAGE_FRAGMENT_BIT;
  shaderStages[1].module = _device->createShader(SHADER_DIR "/depth.frag.spv");
...
VkPipelineLayout DepthPipeline::pipeLayout()
{
  if (!_pipeLayout) {
    auto lay = matrixLayout();
...
VkPipelineLayout DepthPipeline::createPipeLayout()
{
